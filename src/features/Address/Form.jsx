...
export default function AddressForm() {
  return (
    <div className={cx('address-form')}>
      ...
      />
      <Input label="Apt" model=".address2" type="text" />
      <Input label="City" model=".city" type="text" />
      <Input label="State" model=".state" type="text" />
      <Input label="Zip Code" model=".zip" type="text" />
    </div>
  );
}
